...
class BARTProxyHandler(SimpleHTTPRequestHandler):
    ...
    LONDON_STATIONS = {
        # Central London
        '940GZZLUKSX': {'name': "King's Cross St. Pancras", 'lat': 51.5308, 'lon': -0.1238},
        '940GZZLUOXC': {'name': 'Oxford Circus', 'lat': 51.5152, 'lon': -0.1419},
        '940GZZLUPCC': {'name': 'Piccadilly Circus', 'lat': 51.5098, 'lon': -0.1342},
        '940GZZLULVT': {'name': 'Liverpool Street', 'lat': 51.5179, 'lon': -0.0823},
        '940GZZLUWLO': {'name': 'Waterloo', 'lat': 51.5036, 'lon': -0.1143},
        '940GZZLUVIC': {'name': 'Victoria', 'lat': 51.4965, 'lon': -0.1447},
        '940GZZLUBST': {'name': 'Baker Street', 'lat': 51.5226, 'lon': -0.1571},
        '940GZZLULGT': {'name': 'London Bridge', 'lat': 51.5052, 'lon': -0.0863},
        # West London
        '940GZZLUPAH': {'name': 'Paddington', 'lat': 51.5154, 'lon': -0.1755},
        '940GZZLUEAC': {'name': "Earl's Court", 'lat': 51.4920, 'lon': -0.1941},
        '940GZZLUHSK': {'name': 'High Street Kensington', 'lat': 51.5009, 'lon': -0.1925},
        # East London
        '940GZZLUCWR': {'name': 'Canary Wharf', 'lat': 51.5054, 'lon': -0.0195},
        '940GZZLUSTD': {'name': 'Stratford', 'lat': 51.5416, 'lon': -0.0042},
        # North London
        '940GZZLUCMN': {'name': 'Camden Town', 'lat': 51.5392, 'lon': -0.1426},
        '940GZZLUHGR': {'name': 'Highgate', 'lat': 51.5755, 'lon': -0.1403},
        # South London
        '940GZZLUCPK': {'name': 'Clapham Common', 'lat': 51.4616, 'lon': -0.1384},
        '940GZZLUBKE': {'name': 'Brixton', 'lat': 51.4627, 'lon': -0.1145},
    }
